        ...
        for(int i=0; i<5; i++){
            for(int j=0; j<6; j++){
                ...
                if(isCritical(i, j, Record) && color[i][j] == Blue){
                    if(i==0 && j==0){
                        if( (color[1][0] == Red && Record[1][0] == 2)
                           || (color[0][1] == Red && Record[0][1] == 2) ) score -= 4;
                        score += 4;
                    }else if(i==0 && j==5){
                        if( (color[1][5] == Red && Record[1][5] == 2)
                           || (color[0][4] == Red && Record[0][4] == 2) ) score -= 4;
                        score += 4;
                    }else if(i==4 && j==5){
                        if( (color[4][4] == Red && Record[4][4] == 2)
                           || (color[3][5] == Red && Record[3][5] == 2) ) score -= 4;
                        score += 4;
                    }else if(i==4 && j==0){
                        if( (color[3][0] == Red && Record[3][0] == 2)
                           || (color[4][1] == Red && Record[4][1] == 2) ) score -= 4;
                        score += 4;
                    }else if(i>0 && i<4 && j==0){
                        if((isCritical(i-1, j, Record) && color[i-1][j] == Red)
                            || (isCritical(i+1, j, Record) && color[i+1][j] == Red)
                            || (isCritical(i, j+1, Record) && color[i][j+1] == Red)) score -= 4;
                        score += 4;
                    }else if(i>0 && i<4 && j==5){
                        if((isCritical(i-1, j, Record) && color[i-1][j] == Red)
                            || (isCritical(i+1, j, Record) && color[i+1][j] == Red)
                        ...
                        if((isCritical(i, j-1, Record) && color[i][j-1] == Red)
                            || (isCritical(i, j+1, Record) && color[i][j+1] == Red)
                            || (isCritical(i+1, j, Record) && color[i+1][j] == Red)) score -= 4;
                        score += 4;
                    }else if(j>0 && j<5 && i==4){
                        if((isCritical(i, j-1, Record) && color[i][j-1] == Red)
                            || (isCritical(i, j+1, Record) && color[i][j+1] == Red)
                    ...
                    if(i==0 && j==0){
                        if( (color[1][0] == Blue && Record[1][0] == 2)
                           || (color[0][1] == Blue && Record[0][1] == 2) ) score += 4;
                        score -= 4;
                    }else if(i==0 && j==5){
                        if( (color[1][5] == Blue && Record[1][5] == 2)
                           || (color[0][4] == Blue && Record[0][4] == 2) ) score += 4;
                        score -= 4;
                    }else if(i==4 && j==5){
                        if( (color[4][4] == Blue && Record[4][4] == 2)
                           || (color[3][5] == Blue && Record[3][5] == 2) ) score += 4;
                        score -= 4;
                    }else if(i==4 && j==0){
                        if( (color[3][0] == Blue && Record[3][0] == 2)
                           || (color[4][1] == Blue && Record[4][1] == 2) ) score += 4;
                        score -= 4;
                    }else if(i>0 && i<4 && j==0){
                        if((isCritical(i-1, j, Record) && color[i-1][j] == Blue)
                            || (isCritical(i+1, j, Record) && color[i+1][j] == Blue)
                            || (isCritical(i, j+1, Record) && color[i][j+1] == Blue)) score += 4;
                        score -= 4;
                    }else if(i>0 && i<4 && j==5){
                        if((isCritical(i-1, j, Record) && color[i-1][j] == Blue)
                            || (isCritical(i+1, j, Record) && color[i+1][j] == Blue)
                        ...
                        if((isCritical(i, j-1, Record) && color[i][j-1] == Blue)
                            || (isCritical(i, j+1, Record) && color[i][j+1] == Blue)
                            || (isCritical(i+1, j, Record) && color[i+1][j] == Blue)) score += 4;
                        score -= 4;
                    }else if(j>0 && j<5 && i==4){
                        if((isCritical(i, j-1, Record) && color[i][j-1] == Blue)
                            || (isCritical(i, j+1, Record) && color[i][j+1] == Blue)
                ...
                /*if( (i>0 && color[i-1][j] == Black) || (i<4 && color[i+1][j] == Black)
                    ...
                    || (i==0 && (j==0 || j==5)) || (i==4 && (j==0 || j==5)) ){
                        if(color[i][j] == Blue) score += Record[i][j];
                        else if(color[i][j] == Red) score -= Record[i][j];
                    }*/
            }
        }
