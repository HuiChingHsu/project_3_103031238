class Student{
    public:
            ...
            for(int i=0; i<5; i++){
                for(int j=0; j<6; j++){
                    if(color[i][j] == White || color[i][j] == Blue){
                        ...
                        int moveVal = MiniMax(Record, color, 0, Blue);
                    ...
                    if(color[i][j] == White || color[i][j] == Red){
                        ...
                        int moveVal = MiniMax(Record, color, 0, Red);
        ...
        //adjustment of board
        void chain(int x, int y, Color c, int (&Record)[5][6], Color (&color)[5][6])
        {
        ...
        int MiniMax(int Record[5][6], Color color[5][6], int depth, Color inputColor)
        {
            ...
            if(inputColor == Blue){
                ...
                for(int i=0; i<5; i++){
                    for(int j=0; j<6; j++){
                        ...
                        best = max(best, MiniMax(Record, color, depth+1, Red));
            ...
            if(inputColor == Red){
                ...
                for(int i=0; i<5; i++){
                    for(int j=0; j<6; j++){
                        ...
                        //choose the maximum value
                        best = min(best, MiniMax(Record, color, depth+1, Red));
